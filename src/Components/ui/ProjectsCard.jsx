...
const ProjectsCard = ( { text, pText, url, aosDelay}) => {
    return (
        <div data-aos="fade-up" data-aos-delay={aosDelay} className="px-5 w-[375px] xl:w-[400px] overflow-hidden rounded-xl flex flex-col gap-5 text-black bg-purple-300  xl:shadow-xl xl:hover:shadow-gray-400 xl:transition-all items-center py-4 duration-300 cursor-pointer">
